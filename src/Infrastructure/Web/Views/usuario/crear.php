                        ...
                        <form action="<?= base_url() ?>/usuario/registrar" method="post">
                           ...
                           <div class="row">
                              <div class="form-group col-md-6">
                                 ...
                                 <input type="text" name="nombre" maxlength="25" required class="form-control" id="nombre" placeholder="Nombre">
                              </div>
                              <div class="form-group col-md-6">
                                 <label class="form-label" for="apellido">Apellido:</label>
                                 <input type="text" name="apellido" maxlength="25" required class="form-control" id="apellido" placeholder="Apellido">
                              </div>
                              <div class="form-group col-md-6">
                                 <label class="form-label" for="usuario">Usuario:</label>
                                 <input type="text" name="usuario" maxlength="25" required class="form-control" id="usuario" placeholder="Usuario">
                              </div>
                              <div class="form-group col-md-6">
                                 <label class="form-label" for="email">Email:</label>
                                 <input type="email" name="email" maxlength="50" required class="form-control" id="email" placeholder="Email">
                              </div>
                              <div class="form-group col-md-6">
                              ...
                              <div class="form-group col-md-6">
                                 ...
                                 <input type="password" name="confirm-password" required class="form-control" id="confirm-password" placeholder="Confirmar Contraseña">
                              </div>
                              <div class="form-group col-md-6">
